...
* **Installation Friendly**: Depend only on `COMPAS <https://https://compas.dev/compas/latest/>`_, `PyOpenGL <https://https://pypi.org/project/PyOpenGL/>`_ and `PySide6 <https://pypi.org/project/PySide6/>`_. Installation with pip is fast and easy ...
